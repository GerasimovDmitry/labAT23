...
public class Labat23ApplicationTests {
    @Container
    public static PostgreSQLContainer<?> postgresSQLContainer = new PostgreSQLContainer<>("postgres:15")
            .withDatabaseName("labsat")
            .withUsername("postgres")
            .withPassword("1437root")
    ...
    public void calculatorByParameters() throws ParseException {
        ...
        Date startDate = df.parse("2021-1-20");
        Date endDate = df.parse("2022-12-30");
    ...
    public void findByParameters() throws Exception {
        ...
        var response = this.mockMvc.perform(get("/calculations/findByParameters?endDate=2021-12-20&numberSystemOne=2&numberSystemTwo=2&startDate=2022-12-30")
